...
<component :is="componente">
    ...
    <!-- <Vermelho> <span>Conteúdo do Componente <strong>Azul</strong></span></Vermelho>
    <Verde> <span>Conteúdo do Componente <strong>Verde</strong></span></Verde>
    <Azul> <span>Conteúdo do Componente <strong>Vermelho</strong></span></Azul> -->
  </div>
</template>
